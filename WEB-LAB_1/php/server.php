...
foreach ($_SESSION['data'] as $elem){
	echo "<div class='results'>";
	    echo "<div class='table_column' id='column_x'>". round($elem['x'],5). "</div>";
	    echo "<div class='table_column' id='column_y'>". round($elem['y'],5) ."</div>";
	    echo "<div class='table_column' id='column_R'>". round($elem['r'],5)."</div>";
